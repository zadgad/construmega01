                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('C.I.') }}</label>
                                    <div class="col-sm-7">
                                      <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="carn" id="input-name" type="text" placeholder="{{ __('C.I.') }}" value="{{ old('carn', $users->ci2) }}" required="true" aria-required="true"/>
                                        @if ($errors->has('name'))
                                          <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                        @endif
                                      </div>
